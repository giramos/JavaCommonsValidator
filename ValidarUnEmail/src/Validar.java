 ...
 * Validar una Tarjeta De Crédito VISA
 */
...
public class Validar {
	...
	public static void main(String[] args) {
		...
		urls.add("41111111111111111"); // Demasiados dígitos
		
		// Recorremos la lista
		for (String valor : urls) {
			System.out.println("La URL: [" + valor + "] es " + (creditCardValidator.isValid(valor) ? "válida" : "inválida"));
